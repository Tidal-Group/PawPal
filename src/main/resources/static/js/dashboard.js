...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (formModificaDati) {
        ...
        const specializzazione = formModificaDati.querySelector('#specializzazione'); 
        const disponibilita = formModificaDati.querySelector('#disponibilita');       
        ...
        formModificaDati.addEventListener('submit', (e) => {
            ...
            if (nome && !validaTestoNonVuoto(nome, 'Nome')) 
                isValid = false;
            if (cognome && !validaTestoNonVuoto(cognome, 'Cognome')) 
                isValid = false;
